...
// const URLEND = "node.trade11.ai/";

// export const baseurl = "http://172.16.2.30:2186/"; //  local url
// export const baseurlSocket = "ws://172.16.2.30:2186/"; // new local URL

export const baseurl = "https://" + URLEND; // new stagin url
export const baseurlSocket = "wss://" + URLEND; // new stagin URL
export const reCaptchaKey = process.env.reCaptchaKey;
...
export const api_configs = {
  ...
  withDrawTwoFactorAuth: `${wallet}/withDrawTwoFactorAuth`,
  transactionHistory: `${wallet}/transactionHistory`,
  graphRWUser: `${wallet}/graphRWUser`,
